"""
train_model_v6.py — Lift the non-steep classes toward 100%.
...
TFLITE_PATH = os.path.join(MODEL_DIR, "quantized_model", "model_quant_v6.tflite")
HEADER_PATH = os.path.join(SCRIPT_DIR, "qemu_app", "src", "model_data_v6.h")
...
def tflite_to_c_header(tflite_data, header_path):
    ...
    with open(header_path, "w") as f:
        f.write("/* Auto-generated by train_model_v6.py — do not edit. */\n")
...
def main():
    ...
    print("=" * 64)
    print("  TRAFFIC SIGN RECOGNITION — MODEL TRAINING v6")
    ...
    model.save(os.path.join(MODEL_DIR, "float_model_v6.keras"))
    ...
    if int8_acc > BASELINE_INT8_ACC:
        print(f"\n  ✅ BEATS baseline (+{int8_acc - BASELINE_INT8_ACC:.1f}%). "
              f"Promote model_data_v6.h → model_data.h to ship.")
    else:
